...
#define Swhitespace 16

/* customized errno */
int re_errno = LP_RE_NOERR;
	...
	if (p1<bufp->buffer || bufp->buffer+bufp->used<p1)
	  {
		...
		re_errno = LP_RE_JUMP_OUT_BOUNDS;
	    return 0;
	  }
